    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalTraining", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarmUp", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "WorkoutExerciseDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutExerciseDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkoutId = table.Column<int>(type: "integer", nullable: false),
                    WarmUpId = table.Column<int>(type: "integer", nullable: false),
                    AdditionalTrainingId = table.Column<int>(type: "integer", nullable: false),
                    PlanTrainingDayDetailsId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanTrainingDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanTrainingDays_AdditionalTraining_AdditionalTrainingId",
                        column: x => x.AdditionalTrainingId,
                        principalTable: "AdditionalTraining",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlanTrainingDays_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlanTrainingDays_WarmUp_WarmUpId",
                        column: x => x.WarmUpId,
                        principalTable: "WarmUp",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlanTrainingDays_Workouts_WorkoutId",
                        column: x => x.WorkoutId,
                        principalTable: "Workouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanTrainingDays_AdditionalTrainingId",
                table: "PlanTrainingDays",
                column: "AdditionalTrainingId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanTrainingDays_PlanId",
                table: "PlanTrainingDays",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanTrainingDays_WarmUpId",
                table: "PlanTrainingDays",
                column: "WarmUpId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanTrainingDays_WorkoutId",
                table: "PlanTrainingDays",
                column: "WorkoutId");
